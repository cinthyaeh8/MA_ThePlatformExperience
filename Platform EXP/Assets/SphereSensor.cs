...
public class SphereSensor : MonoBehaviour
{
    ...
    void OnTriggerExit(Collider other)
    {
        if (other.CompareTag("Balls"))
        {
            LightAnimator1.SetBool("BLights", false);
            print("BLights...");

            LightAnimator2.SetBool("BLights", false);
            print("Blights...");

            LightAnimator3.SetBool("BLights", false);
            print("BLights...");

            LightAnimator4.SetBool("BLights", false);
            print("BLights...");

            LightAnimator5.SetBool("BLights", false);
            print("BLights...");

            LightAnimator6.SetBool("BLights", false);
            print("BLights...");
        }
